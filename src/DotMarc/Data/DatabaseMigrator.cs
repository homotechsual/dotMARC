...
/// shared database. Every replica still calls this at startup: the lock only serializes them - /// whichever one goes first actually applies pending migrations, and the rest, having waited
