...
- Modify: `test/DotMarc.Tests/Ingestion/PollingServiceDiActivationTests.cs`
...
- [ ] **Step 5: Rewrite PollingServiceDiActivationTests against the fixture**
...
- [ ] **Step 6: Rewrite ProgramDiValidationTests against the fixture**
...
```bash
git add test/DotMarc.Tests/DotMarc.Tests.csproj test/DotMarc.Tests/Internal/PostgresContainerFixture.cs test/DotMarc.Tests/Data/DotMarcDbContextTests.cs test/DotMarc.Tests/Ingestion/PollingServiceTests.cs test/DotMarc.Tests/Ingestion/PollingServiceDiActivationTests.cs test/DotMarc.Tests/ProgramDiValidationTests.cs
