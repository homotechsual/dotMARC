...
- One page per domain (Domain Detail) for checking and fixing all of that domain's DNS records -   DMARC, TLS reporting, and MTA-STS - with no separate page to visit for any of them.
