...
and - since the template provisions empty Key Vault secret entries but doesn't populate them - explicit steps for setting the three secret values into Key Vault after deployment (the Entra app
